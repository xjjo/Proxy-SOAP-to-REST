...
=========================================   
The goal of this project is to Proxy a SOAP webservice into a Rest Web-Service
the idea is expose a Rest webservice in order to simplify the interface of an given SOAP service.